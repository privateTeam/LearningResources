...
package org.beadle.framework.view;
 ...
 */
public class ReturnTypeViewResolver extends WebApplicationObjectSupport implements ViewResolver, Ordered, InitializingBean {

	private static final Log logger = LogFactory.getLog(ReturnTypeViewResolver.class);
		...
		for (View candidateView : candidateViews) {
			if (StringUtils.hasText(candidateView.getContentType())) {
				...
				if(result == null && candidateContentType.isCompatibleWith(MediaType.TEXT_HTML)){
					...
					attrs.setAttribute(View.SELECTED_CONTENT_TYPE, candidateContentType, RequestAttributes.SCOPE_REQUEST);
